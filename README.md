...
| [`jacobian_lens_chat.py`](examples/jacobian_lens_chat.py) | Live J-space visualizer — generates a self-contained HTML page to chat with a served model and watch the top-k Jacobian-lens readout at a layer you pick, live. |

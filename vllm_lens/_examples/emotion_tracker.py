...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Probe layer (default: ~2/3 of the model's depth)",
    )
    parser.add_argument(
        "--stories-per-emotion",
        type=int,
    ...
    # Layer ~2/3 through the model (following the paper), resolved from the
    # served model unless the user pinned one.
    if args.layer is None:
        args.layer = int(get_num_layers(client.model) * 2 / 3)
